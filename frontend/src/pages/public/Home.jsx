...
const homeContent = {
  ...
  hero: {
    ...
    description: `BankManager est votre tableau de bord financier personnel : suivez vos comptes, analysez vos dépenses et atteignez vos objectifs d'épargne, le tout en un seul endroit.`,
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="flex lg:hidden">
            ...
            >
              <span className="sr-only">{homeContent.menu.openLabel}</span>
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              ...
              >
                <span className="sr-only">{homeContent.menu.closeLabel}</span>
